...
activities = {
    ...
    "Soccer Club": {
        "description": "Develop soccer skills and enjoy friendly match play",
    ...
    "Art Studio": {
        ...
        "max_participants": 18,
        "participants": ["ava@mergington.edu", "julia@mergington.edu"]
    },
    "Drama Club": {
        "description": "Rehearse scenes, practice performance skills, and stage productions",
